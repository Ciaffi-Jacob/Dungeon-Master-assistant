...
import rocks.zipcode.repository.ProfileRepository;
...
class ProfileResourceIT {
    ...
    public static Profile createEntity(EntityManager em) {
        Profile profile = new Profile().userName(DEFAULT_USER_NAME).password(DEFAULT_PASSWORD).uid(DEFAULT_UID);
        return profile;
    }
    ...
    public static Profile createUpdatedEntity(EntityManager em) {
        Profile profile = new Profile().userName(UPDATED_USER_NAME).password(UPDATED_PASSWORD).uid(UPDATED_UID);
        return profile;
    }
    ...
    void createProfile() throws Exception {
        ...
        assertThat(testProfile.getUid()).isEqualTo(DEFAULT_UID);
    }
    ...
    void putExistingProfile() throws Exception {
        ...
        updatedProfile.userName(UPDATED_USER_NAME).password(UPDATED_PASSWORD).uid(UPDATED_UID);
        ...
        assertThat(testProfile.getUid()).isEqualTo(UPDATED_UID);
    }
    ...
    void partialUpdateProfileWithPatch() throws Exception {
        ...
        partialUpdatedProfile.userName(UPDATED_USER_NAME).password(UPDATED_PASSWORD).uid(UPDATED_UID);
