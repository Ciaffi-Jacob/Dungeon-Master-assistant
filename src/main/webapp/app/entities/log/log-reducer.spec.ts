...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOG actions', async () => {
      const expectedActions = [
        {
